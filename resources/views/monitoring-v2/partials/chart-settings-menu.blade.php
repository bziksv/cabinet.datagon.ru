        ...
        <div class="dropdown-menu dropdown-menu-lg cabinet-mon-v2-chart-settings-menu p-3"
            ...
            <div class="mb-0">
                ...
                <div class="cabinet-mon-v2-chart-series-presets" role="group">
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-chart-setting="seriesPreset" data-series-preset="1">TOP-1</button>
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-chart-setting="seriesPreset" data-series-preset="3">TOP-3</button>
                    ...
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-chart-setting="seriesPreset" data-series-preset="35102030100">3/5/10/20/30/100</button>
