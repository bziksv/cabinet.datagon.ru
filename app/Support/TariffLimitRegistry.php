    ...
    public static function entries(): array
    {
        return [
            ...
            [
                ...
                'module' => __('Search suggestions'),
                'hint' => __('Monthly search suggest collects: 1 seed phrase in one search engine = 1 unit.'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'SearchSuggestionsHistory',
                'module' => __('Search suggestions history'),
                'hint' => __('How many suggest collects can be stored. Free = 0 (history for paid plans only).'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'DomainRecords',
                'module' => __('Domain records'),
                'hint' => __('Monthly WHOIS + DNS lookups: 1 domain check = 1 unit.'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'DomainRecordsHistory',
                'module' => __('Domain records history'),
                'hint' => __('How many WHOIS/DNS snapshots can be stored for comparison.'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'SiteTypes',
                'module' => __('Site types'),
                'hint' => __('Site types tariff hint'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'SiteTypesHistory',
                'module' => __('Site types history'),
                'hint' => __('How many site-type checks can be stored. Free = 0 (history for paid plans only).'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'PhraseCommerce',
                'module' => __('Phrase commerce'),
                'hint' => __('Phrase commerce tariff hint'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'PhraseCommerceHistory',
                'module' => __('Phrase commerce history'),
                'hint' => __('How many geo/commerce checks can be stored. Free = 0.'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'TextUniqueness',
                'module' => __('Text uniqueness'),
                'hint' => __('Text uniqueness tariff hint'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'TextUniquenessHistory',
                'module' => __('Text uniqueness history'),
                'hint' => __('How many uniqueness checks can be stored. Free = 0.'),
                'enforcement' => self::ENFORCEMENT_STRICT,
            ],
            [
                'code' => 'GeneratorWords',
