...
class SeedRelevanceAnalysisRestorationNews extends Migration
{
    ...
    public function up(): void
    {
        DB::table('news')->insert([
            ...
            'content' => <<<'HTML'
<p>Доброго дня!</p>
<p><strong>Восстановили и доработали анализ релевантности</strong> — отчёт снова собирается корректно, таблицы и облака отображаются как надо. Кратко по изменениям (Станислав):</p>
<ul>
...
<p>Вопросы — <a href="mailto:info@titlo.ru">info@titlo.ru</a>.</p>
HTML,
            'files' => null,
            'number_of_likes' => 0,
