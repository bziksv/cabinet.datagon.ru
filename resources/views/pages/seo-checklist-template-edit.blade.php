@component('component.card', [
    ...
    <div class="cabinet-sc-page"
         ...
         data-tpl-move-url-template="{{ url('/seo-checklist/templates/'.$template->id.'/tasks/__ID__/move') }}"
         data-tpl-stage-move-url-template="{{ url('/seo-checklist/templates/'.$template->id.'/stages/__KEY__/move') }}"
         data-tpl-stage-update-url-template="{{ url('/seo-checklist/templates/'.$template->id.'/stages/__KEY__') }}"
         data-tpl-stage-delete-url-template="{{ url('/seo-checklist/templates/'.$template->id.'/stages/__KEY__/delete') }}"
         data-tpl-subtask-url-template="{{ url('/seo-checklist/templates/'.$template->id.'/tasks/__ID__/subtasks') }}"
