...
class GenerationCategoryQueue implements ShouldQueue
{
    ...
    private function getWords() {
        ...
        if ($isRefine) {
            $addWords .= "ДОРАБОТКА: объём текста ДОЛЖЕН вырасти — допиши абзацы/пункты,\n"
                . "чтобы вплести недостающие уместные слова. Не держи прежний размер.\n"
                . "Без воды и без off-topic, но рост объёма — ожидаем и нужен.\n\n";
        } else {
            $addWords .= "\n";
        }
