...
use App\PhraseCommerceUsage;
use App\User;
use Carbon\Carbon;
use Illuminate\Support\Facades\Auth;

class PhraseCommerceLimits
{
    ...
    {
        return self::tariffInt('PhraseCommerce', $user);
    }

    public static function historyLimitForUser(?User $user = null): ?int
    {
        return self::tariffInt('PhraseCommerceHistory', $user);
    }
    ...
    public static function usedForUser(?User $user = null, ?string $period = null): int
    {
        ...
        return (int) PhraseCommerceUsage::query()
    ...
    public static function spend(int $cost, ?User $user = null): void
    {
        ...
        $row = PhraseCommerceUsage::query()->firstOrCreate(
    ...
    {
        return self::tariffMessage('PhraseCommerce', $user);
    }

    public static function historyLimitMessage(?User $user = null): ?string
    {
        return self::tariffMessage('PhraseCommerceHistory', $user);
    }
    ...
    public static function savedCount(?User $user = null): int
    {
        ...
        return (int) PhraseCommerceHistory::query()->where('user_id', $user->id)->count();
    }
