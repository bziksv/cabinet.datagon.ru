<div class="cabinet-mon-v2-child-chart-controls">
    ...
    <div class="cabinet-mon-v2-child-chart-series-presets mb-2" role="group" aria-label="{{ __('Monitoring child chart series group') }}">
        ...
        <div class="d-flex flex-wrap gap-1">
            <button type="button" class="btn btn-outline-secondary btn-sm" data-child-chart-setting="seriesPreset" data-series-preset="1">TOP-1</button>
            <button type="button" class="btn btn-outline-secondary btn-sm" data-child-chart-setting="seriesPreset" data-series-preset="3">TOP-3</button>
            ...
            <button type="button" class="btn btn-outline-secondary btn-sm" data-child-chart-setting="seriesPreset" data-series-preset="35102030100">3/5/10/20/30/100</button>
