@component('component.card', [
    'title' => __('HTML editor') . ' — ' . __('Edit HTML text'),
    'titleHtml' => e(__('HTML editor')) . ' — ' . e(__('Edit HTML text')) . ' · ' . e($project->project_name ?? '') . view('partials.cabinet-module-version-badge', ['configKey' => 'cabinet-html-editor'])->render(),
])
    @slot('css')
    ...
    <div class="cabinet-html-editor-page cabinet-html-editor-form" data-he-lang="{{ $lang }}">
        @include('html-editor.partials.cabinet-he-nav', [
            'backUrl' => route('HTML.editor') . '?project=' . $project->project_id,
        ])
