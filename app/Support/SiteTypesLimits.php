...
use App\SiteTypesUsage;
use App\User;
use Carbon\Carbon;
use Illuminate\Support\Facades\Auth;

class SiteTypesLimits
{
    ...
    {
        return self::tariffInt('SiteTypes', $user);
    }

    public static function historyLimitForUser(?User $user = null): ?int
    {
        return self::tariffInt('SiteTypesHistory', $user);
    }
    ...
    public static function usedForUser(?User $user = null, ?string $period = null): int
    {
        ...
        return (int) SiteTypesUsage::query()
    ...
    public static function spend(int $cost, ?User $user = null): void
    {
        ...
        $row = SiteTypesUsage::query()->firstOrCreate(
    ...
    {
        return self::tariffMessage('SiteTypes', $user);
    }

    public static function historyLimitMessage(?User $user = null): ?string
    {
        return self::tariffMessage('SiteTypesHistory', $user);
    }
    ...
    public static function savedCount(?User $user = null): int
    {
        ...
        return (int) SiteTypesHistory::query()->where('user_id', $user->id)->count();
    }
