    ...
    $moduleLinks = [
        'seo' => [
            [
                ...
                'text' => 'Сравнение с ТОП выдачи — в модуле «Анализ конкурентов», без повторного проверки.',
            ...
            [
                ...
                'text' => 'История и сравнение META. В аудите — snapshot seo_meta_errors по проверке.',
            ...
            [
                'title' => 'Анализатор релевантности',
                'text' => 'TF и покрытие по запросу↔посадочной. В аудите — вкладка «Релевантность» по мониторингу.',
        ...
        'tech' => [
            [
                ...
                'text' => 'Разовая проверка заголовков URL. В аудите — security pack по всему проверке.',
                'route' => 'pages.headers',
