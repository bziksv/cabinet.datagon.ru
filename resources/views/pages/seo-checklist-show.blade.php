@component('component.card', [
    ...
    <div class="cabinet-sc-page"
         ...
         data-update-url-template="{{ url('/seo-checklist/'.$project->id.'/items/__ID__') }}"
         data-delete-url-template="{{ url('/seo-checklist/'.$project->id.'/items/__ID__/delete') }}"
         data-timer-start-url-template="{{ url('/seo-checklist/'.$project->id.'/items/__ID__/timer/start') }}"
         data-timer-stop-url-template="{{ url('/seo-checklist/'.$project->id.'/items/__ID__/timer/stop') }}"
         data-time-url-template="{{ url('/seo-checklist/'.$project->id.'/items/__ID__/time') }}"
