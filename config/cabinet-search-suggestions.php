...
return [
    ...
    /**
     * Готовые стоп-слова для семантики из подсказок (кнопки под полем).
     * Клик дописывает в textarea без дублей.
     */
    'stop_word_presets' => [
        'junk' => [
            'label' => 'Мусор',
            'hint' => 'бесплатно / скачать / онлайн',
            'words' => [
                'бесплатно', 'скачать', 'онлайн', 'торрент', 'смотреть', 'слушать',
                'читать', 'pdf', 'doc', 'docx', 'ppt', 'pptx', 'rar', 'zip',
            ],
        ],
        'jobs' => [
            'label' => 'Работа',
            'hint' => 'вакансии и зарплаты',
            'words' => [
                'вакансии', 'вакансия', 'работа', 'резюме', 'зарплата', 'зп',
                'удалённо', 'удаленно', 'карьера', 'hh',
            ],
        ],
        'study' => [
            'label' => 'Учёба',
            'hint' => 'рефераты и курсовые',
            'words' => [
                'реферат', 'курсовая', 'диплом', 'контрольная', 'сочинение',
                'презентация', 'доклад', 'шпаргалка', 'ответы',
            ],
        ],
        'classifieds' => [
            'label' => 'Объявления',
            'hint' => 'б/у и площадки',
            'words' => [
                'авито', 'юла', 'б/у', 'бу', 'комиссионка', 'объявления',
                'продам', 'куплю', 'с рук',
            ],
        ],
        'media' => [
            'label' => 'Медиа',
            'hint' => 'фото / видео / вики',
            'words' => [
                'фото', 'картинки', 'обои', 'видео', 'youtube', 'википедия', 'вики',
            ],
        ],
    ],
