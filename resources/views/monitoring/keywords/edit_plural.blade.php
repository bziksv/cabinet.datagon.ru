    ...
    <div class="modal-body">
        ...
        @can('form_target_monitoring')
            <div class="form-group">
                ...
                {{ Form::select('target', [1 => 1, 3 => 3, 5 => 5, 10 => 10, 50 => 50, 100 => 100], null, ['class' => 'form-select', 'placeholder' => 'Выбрать...']) }}
            </div>
        @endcan

        <div class="form-group">
            <label class="col-form-label">{{ __('Groups') }}:</label>
            {{ Form::select('monitoring_group_id', $project->groups->pluck('name', 'id'), null, ['class' => 'form-select', 'placeholder' => 'Выбрать...']) }}
        </div>
