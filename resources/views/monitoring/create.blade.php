        ...
        <script>
            window.cabinetMonCreateConfig = {
                ...
                i18n: {
                    ...
                    regionSearching: @json(__('Monitoring v2 create region searching')),
                    regionNotFound: @json(__('Monitoring v2 create region not found')),
                    regionLoadError: @json(__('Monitoring v2 create region load error')),
