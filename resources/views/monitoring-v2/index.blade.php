        ...
        <script>
            window.cabinetMonV2Config = {
                ...
                i18n: {
                    ...
                    portfolioTrendStageWait: @json(__('Monitoring v2 portfolio trend stage wait')),
                    portfolioTrendStageDb: @json(__('Monitoring v2 portfolio trend stage db')),
                    portfolioTrendStageAgg: @json(__('Monitoring v2 portfolio trend stage agg')),
                    portfolioTrendStageChart: @json(__('Monitoring v2 portfolio trend stage chart')),
                    portfolioTrendStageCache: @json(__('Monitoring v2 portfolio trend stage cache')),
                    ...
                    portfolioTrendCached: @json(__('Monitoring v2 portfolio trend cached')),
