@component('component.card', [
    'title' => __('HTML editor') . ' — ' . __('Add HTML text'),
    'titleHtml' => e(__('HTML editor')) . ' — ' . e(__('Add HTML text')) . view('partials.cabinet-module-version-badge', ['configKey' => 'cabinet-html-editor'])->render(),
])
    @slot('css')
