...
use App\ViewComposers\CompetitorAnalysisLimitsComposer;
...
class ComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('layouts.partials.app-header', CompetitorAnalysisLimitsComposer::class);
        view()->composer(['competitors.index', 'competitors.config'], CompetitorAnalysisLimitsComposer::class);
