...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/admin/database/optimize/{table}/status', 'DatabaseAdminController@optimizeStatus')->name('admin.database.optimize.status');
    ...
    Route::get('site-audit/crawl/{id}/report/index_count_mismatch/extra', 'SiteAuditController@exportIndexExtraUrls')->name('pages.site-audit.report.index-extra')->middleware('permission:Site audit');
    ...
    Route::post('site-audit/crawl/{id}/note/clear-pattern', 'SiteAuditController@clearPatternNote')->name('pages.site-audit.note.clear-pattern')->middleware('permission:Site audit');
    ...
    Route::post('checklist/chronicle/unread-prefs', 'SeoChecklistController@updateChronicleUnreadPrefs')->name('pages.seo-checklist.chronicle.unread-prefs')->middleware('permission:SEO Checklist');
