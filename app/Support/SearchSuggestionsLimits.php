...
use App\SearchSuggestionsUsage;
use App\User;
use Carbon\Carbon;
use Illuminate\Support\Facades\Auth;

class SearchSuggestionsLimits
{
    ...
    {
        return self::tariffInt('SearchSuggestions', $user);
    }

    public static function historyLimitForUser(?User $user = null): ?int
    {
        return self::tariffInt('SearchSuggestionsHistory', $user);
    }
    ...
    public static function usedForUser(?User $user = null, ?string $period = null): int
    {
        ...
        return (int) SearchSuggestionsUsage::query()
    ...
    public static function spend(int $cost, ?User $user = null): void
    {
        ...
        $row = SearchSuggestionsUsage::query()->firstOrCreate(
    ...
    {
        return self::tariffMessage('SearchSuggestions', $user);
    }

    public static function historyLimitMessage(?User $user = null): ?string
    {
        return self::tariffMessage('SearchSuggestionsHistory', $user);
    }
    ...
    public static function savedCount(?User $user = null): int
    {
        ...
        return (int) SearchSuggestionsHistory::query()->where('user_id', $user->id)->count();
    }
